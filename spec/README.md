...
| [requirements/](./requirements/) | 已实现 + 规划中需求方案 |
...
- **Extension CLI server + exec_cli**：看 [requirements/extension-cli-server.md](./requirements/extension-cli-server.md) + [ARCHITECTURE.md §9](./ARCHITECTURE.md#9-extensions-细化)
...
│   └── extension-cli-server.md  # Extension CLI HTTP server + exec_cli（已实现，PR #11）
